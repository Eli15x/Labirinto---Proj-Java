       ...
       // proc.setLinha(proc.getLinhaInicial()); //primeira vez que esta passando aqui
		...
		while(!(fim)){
           ...
           while(!(proc.ePosicaoFinal(atual.getLinha(), atual.getColuna()))){
			...
			//System.out.println("Minha Linha Atual PROGRAMA (abaixo do conferir posicao) : "+proc.getLinhaAtual());
			//System.out.println("Minha coluna Atual PROGRAMA (abaixo do conferir posicao) :"+ proc.getColunaAtual());

			System.out.println("Minha Linha  em Atual PROGRAMA (encima do conferir posicao) : "+atual.getLinha());
			System.out.println("Minha coluna em Atual PROGRAMA (encima  do conferir posicao) :"+ atual.getColuna());
           ...
           atual.setLinha(proc.getLinhaAtual());
		   atual.setColuna(proc.getColunaAtual());
		   System.out.println(" POS CONFERIRPOSICOES Minha Linha em Atual PROGRAMA (abaixo do conferir posicao) : "+atual.getLinha());
		   System.out.println(" POS CONFERIRPOSICOES Minha coluna em Atual PROGRAMA (abaixo do conferir posicao) :"+ atual.getColuna());
