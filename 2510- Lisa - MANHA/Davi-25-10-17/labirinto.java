...
/**
 * 
 * @return retorna a posicao inicial da linha
 */
...
/**
 * 
 * @return retorna coluna a posicao  inicial da linha
 */
...
/**
 * 
 * @return retorna a posicao da linha final
 */
...
/**
 * 
 * @return retorna a posicao da coluna final
 */
...
/*	public boolean posicaoValida()
 ...
 /**
  * 
  * @param aux auxilia na localizacao entre as linhas e colunas
  */
...
/**
 * 
 * @throws Exception caso as linhas, ou colunas, sejam invalídas. Lança-se excessao 
 */
...
/**
 * 
 * @param linha recebe linha para verificação
 * @param coluna recebe coluna para verificação
 * @return true caso sejam válidas
 * @throws Exception caso nao sejam validas lança a excessao
 */
...
/**
 * 
 * @return retorna a string "ret" que servira para melhor exibicao do labirinto
 */
