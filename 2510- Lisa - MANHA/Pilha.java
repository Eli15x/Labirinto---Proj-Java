 ...
 * @throws Exception caso os valores sejam inválidos, lança a excessao
 */
 ...
 * @throws Exception caso não há elementos lança excessao
 * 
 */
   ...
   * @throws Exception Caso a pilha ja esteja vazia, lança excessao
   */
  ...
  {
	 if (this.topo == -1) //Posicao -1 indica que nao há nada
	  return true;
   ...
   * @throws Exception caso o valor seja nulo, lança excessao
   */
